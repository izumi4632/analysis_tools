...
# !!! Main.UserApp is configured as an alias for Main.App and you might encounter it in some tests
using Main.App, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "App tests" begin
  @includetests ARGS
end
